...
from src.core.models import (
    OHLCV, MarketData, TradingSignal, SessionConfig, SessionResults,
    AnalysisResult, SupportResistanceLevel, EMACrossover,
...
class TestTradingSignal:
    ...
    def test_trading_signal_with_indicators(self):
        ...
        indicators = [
            ...
            TechnicalIndicator(
                name="MACD",
                value={"macd": Decimal("1.2"), "signal": Decimal("0.8")}
            )
        ]
...
class TestSessionResults:
    ...
    def test_session_results_success_rate_property(self, sample_session_config, sample_market_data):
