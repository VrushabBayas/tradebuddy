...
from src.core.models import OHLCV, MarketData, TradingSignal, AnalysisResult, StrategyType
...
class TestOllamaClient:
    ...
    @pytest.mark.asyncio
    async def test_analyze_market_success(self, client, mock_session, sample_market_data, sample_technical_analysis):
...
- Bullish price action with good momentum"""
    ...
    @pytest.mark.asyncio
    async def test_analyze_market_with_support_resistance_strategy(self, client, mock_session, sample_market_data, sample_technical_analysis):
...
The bearish divergence and high RSI suggest a reversal is imminent."""
        ...
        signals = client._parse_trading_signals(ai_response, market_data, StrategyType.EMA_CROSSOVER)
...
The market is consolidating with no clear direction. Wait for better setup."""
        ...
        signals = client._parse_trading_signals(ai_response, market_data, StrategyType.COMBINED)
    ...
    async def test_invalid_market_data_validation(self, client):
        ...
        with pytest.raises(DataValidationError, match="No OHLCV data provided"):
            await client.analyze_market(empty_market_data, {}, StrategyType.EMA_CROSSOVER)
    ...
    @pytest.mark.asyncio
    async def test_prompt_generation_ema_strategy(self, client, sample_market_data, sample_technical_analysis):
    ...
    @pytest.mark.asyncio
    async def test_prompt_generation_support_resistance_strategy(self, client, sample_market_data, sample_technical_analysis):
    ...
    async def test_signal_parsing_edge_cases(self, client):
        ...
        signals = client._parse_trading_signals(malformed_response, market_data, StrategyType.EMA_CROSSOVER)
