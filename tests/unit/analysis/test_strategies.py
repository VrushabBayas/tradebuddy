...
class TestBaseStrategy:
    ...
    @pytest.mark.asyncio
    async def test_base_strategy_analyze_not_implemented(
        self, sample_market_data, session_config
    ):
...
class TestSupportResistanceStrategy:
    ...
    @pytest.mark.asyncio
    async def test_analyze_with_mock_ollama(
        self, strategy, sample_market_data, session_config
    ):
        ...
        strategy.ollama_client.analyze_market = AsyncMock(
...
class TestEMACrossoverStrategy:
    ...
    @pytest.mark.asyncio
    async def test_analyze_golden_cross(
        self, strategy, sample_market_data, session_config
    ):
...
class TestCombinedStrategy:
    ...
    @pytest.mark.asyncio
    async def test_analyze_high_confidence_signal(
        self, strategy, sample_market_data, session_config
    ):
    ...
    @pytest.mark.asyncio
    async def test_analyze_conflicting_signals(
        self, strategy, sample_market_data, session_config
    ):
